...
public class Stage1Ball extends JPanel implements Stage1Constant, Runnable {
	 ...
	 * 
	 * 
	 * @param rootComponent - 스테이지1의 프레임
	 * <li>게임 시작시 x방향 50%확률로 공이 우 아니면 좌로 가게끔 설정</li>
	 * <li>게임 시작시 y방향 공이 위로 향하게함. 
	 */
	Stage1Ball(Stage1MainFrame rootComponent) {
	...
	private void checkCollision() { 
		...
		if (getBottomCenter().y >= Stage1Bar.y) { 
	 ...
	 */
	boolean isCollideWithBlock(Stage1Block block) {
